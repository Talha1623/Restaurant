    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Add New Addon</h1>
                    <p class="text-gray-600 mt-2">{{ $restaurant->business_name }}</p>
                </div>
        ...
        <div class="bg-white shadow-lg rounded-xl overflow-hidden">
            ...
            <form method="POST" action="{{ route('restaurants.addons.store', $restaurant->id) }}" 
